      ...
      .col-lg-6.col-clientes
        .cajon.color-naranja.mb-4
          .row.justify-content-center
            ...
            .col-lg-8.px-lg-4.p-4
              p.mb-0 Edad a la cual vamos a dirigirnos o nicho de mercado (porción o segmento de éste), es importante hacer un estudio preciso de este punto ya que no todos los productos son para todas las edades, por ejemplo, un videojuego, no es un producto muy factible para un padre de familia, pero sí para su hijo.
      ...
      .col-lg-6.col-clientes
        .cajon.color-naranja.mb-4
          .row.justify-content-center
            ...
            .col-lg-8.px-lg-4.p-4
              p.mb-0 Hábitos de consumo; por ejemplo, hoy en día, hay muchas personas que han optado por una alimentación vegana, vegetariana, celiaca, o simplemente personas que pueden consumir todos los tipos de alimentos, por diferentes motivos.
      .col-lg-6.col-clientes
    ...
    TabsC.color-primario
      .py-3.py-md-4(titulo="La planificación")
        .row.justify-content-center
          ...
          .col-md-6.px-md-5
            .h3 La planificación
            p Antes de iniciar cualquier actividad es indispensable realizar una planificación, esta nos provee los pasos necesarios para una consecución exitosa de cualquier tarea, esto aplica en la retroalimentación o feedback; es importante definir el objetivo de reunirnos con el cliente, identificar cuál es el problema o la pregunta que deseamos responder, cuáles son las incógnitas a despejar que permita una mejor comprensión de la situación; de esta manera, podemos recopilar la información necesaria, relevante y exacta, que por pequeña que parezca, puede llegar a ser muy valiosa.
